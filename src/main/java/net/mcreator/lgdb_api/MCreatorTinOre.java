...
public class MCreatorTinOre extends Elementslgdb_api.ModElement {
	@ObjectHolder("lgdb_api:tinore")
	public static final Block block = null;

	public MCreatorTinOre(Elementslgdb_api instance) {
		super(instance, 37);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 20), Placement.COUNT_RANGE, new CountRangeConfig(18, 0, 0, 62)));
		}
	}
}
