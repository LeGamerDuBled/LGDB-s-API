...
public class MCreatorCopperPlate extends Elementslgdb_api.ModElement {
	@ObjectHolder("lgdb_api:copperplate")
	public static final Item block = null;

	public MCreatorCopperPlate(Elementslgdb_api instance) {
		super(instance, 36);
	}
