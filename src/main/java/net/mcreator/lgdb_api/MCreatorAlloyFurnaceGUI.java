...
public class MCreatorAlloyFurnaceGUI extends Elementslgdb_api.ModElement {
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorAlloyFurnaceGUI(Elementslgdb_api instance) {
		super(instance, 44);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("alloyfurnacegui"));
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public void initContainer(PlayerInventory inv, IInventory inheritedinv) {
			...
			this.addSlot(new Slot(inherited, 0, 8, 39) {
			});
			this.addSlot(new Slot(inherited, 1, 35, 21) {
			});
			this.addSlot(new Slot(inherited, 2, 35, 57) {
			});
			this.addSlot(new Slot(inherited, 3, 134, 39) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				lgdb_api.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("lgdb_api:textures/alloyfurnacegui.png");
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Alloy Furnace", 7, 2, -16777216);
		}
