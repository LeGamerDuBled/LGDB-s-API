...
public class MCreatorCopperIngot extends Elementslgdb_api.ModElement {
	@ObjectHolder("lgdb_api:copperingot")
	public static final Item block = null;

	public MCreatorCopperIngot(Elementslgdb_api instance) {
		super(instance, 34);
	}
